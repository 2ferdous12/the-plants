...
const scoundmars = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row lg:flex-row md:justify-around lg:justify-around max-w-6xl pt-8 lg:pt-20">
...
<br />
            ...
            <img className="w-full" src="/images/planet-mars-internal.svg" alt="" />
          </div>
