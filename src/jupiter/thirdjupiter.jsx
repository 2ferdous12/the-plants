...
<img className="w-full" src="/images/planet-jupiter-internal.svg" alt="" />
    <div className="w-[200px] left-20 top-[80%] text-center mx-auto absolute ">
        <img className="w-full " src="/images/geology-jupiter.png" alt="" />
    </div>
    </div>
         
          </div>
                   <div className="w-[90%] md:w-[40%] lg:w-[30%]  mt-[200px] md:mt-5 lg:mt-5 mb-5text-center mx-auto ">
