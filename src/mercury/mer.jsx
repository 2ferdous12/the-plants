...
const mer = () => {
    return (
<div>
<div className=" block md:hidden lg:hidden flex flex-col text-white  bg-[#070724] justify-center text-center gap-6 w-full ">
<Link to="/mercurytwo" className=" flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
    <div className="w-5 h-5 bg-cyan-500 rounded-full"></div>
     ...
     <Link to="/venus" className=" flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
     ...
     <Link to="/earth" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
     ...
     <Link to="/mars" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
     ...
     <Link to="/jupiter" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
     ...
     <Link to="/saturn" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
       <div className="w-5 h-5 bg-yellow-800 rounded-full"></div>
       <div>
       <a>saturn</a>
       </div>
     </Link>

     <Link to="/uranus" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
       <div className="w-5 h-5 bg-emerald-400 rounded-full"></div>
       <div>
       <a>uranus</a>
       </div>
     </Link>
<Link to="/neptune" className="flex p-5 gap-10 items-center rounded-lg border-b-2 border-solid border-gray-800">
...
<div className=" hidden md:block lg:block  max-w-6xl mx-auto bg-[#070724]  pb-10 ">
...
<NavLink to="/" className={({isActive})=> isActive ? ' bg-cyan-600 w-[250px] flex border-2 p-2 rounded-lg' : 'w-[250px] flex border-2 p-2 rounded-lg'}>
...
<div className="flex flex-col space-y-4 md:flex-row items-center gap-10 md:gap-2 p-4 lg:flex-row md:justify-around lg:justify-around mt-10">
    <div className="text-center border-2 border-solid border-gray-700 w-full rounded-lg p-3 ">
        ...
        <h2 className="text-white text-3xl font-bold">58.6 days</h2>
    </div>
    <div className="text-center border-2 border-solid border-gray-700 w-full rounded-lg  p-3">
        <p className="text-white text-xl  mb-2">REVOLUTION TIME</p>
        <h2 className="text-white text-3xl font-bold">87.97 days</h2>
    </div>
    <div className="text-center border-2 border-solid border-gray-700 w-full rounded-lg  p-3">
        <p className="text-white text-xl  mb-2">radius</p>
        <h2 className="text-white text-3xl font-bold">2,439.7 km</h2>
    </div>
    <div className="text-center border-2 border-solid border-gray-700 w-full rounded-lg p-3">
